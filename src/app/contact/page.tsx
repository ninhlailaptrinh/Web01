        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-12">
              Hãy liên hệ với chúng tôi để được tư vấn giải pháp phù hợp nhất cho doanh nghiệp của bạn.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">contact@techvn.com</p>
                </div>
              </div>
          ...
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isLoading ? <LoadingSpinner /> : 'Gửi tin nhắn'}
              </button>
            </form>
          </div>
        </div>
